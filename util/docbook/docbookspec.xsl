...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="doc stbl xtbl lxslt ptbl d saxon db exsl xlink">
    ...
    <xsl:template name="anchor">
        ...
        <xsl:variable name="is-conformance-list-para" select="ancestor::db:*[@role='conformance-list'] and local-name(.) = 'para' and string-length($id) > 0"/>
