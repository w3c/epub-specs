...
<xsl:stylesheet exclude-result-prefixes="xs rng xd dcterms z rdf zrng zsd a x sch" version="2.0"
	...
	<xsl:template match="rng:*" mode="ecm-build">
	...
	<!-- psps (2010-11-25): get rid of everything not in the rng namespace -->
	...
	<!-- psps-2010-12-12: No don't remove, as Matt G found that the empty inside choice actually carries vital information -->
