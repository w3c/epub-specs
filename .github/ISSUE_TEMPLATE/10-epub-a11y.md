...
description: Issue related to the EPUB Accessibility Recommendation 
labels: Spec-Accessibility
body: 
  - type: markdown
    attributes:
     value: "## Issue on the [EPUB Accessibility](https://www.w3.org/TR/epub-a11y/) Recommendation"
  - type: markdown
    attributes:
     value: __Before opening an issue__, please check that it has not already been resolved in the latest [editor's draft](https://w3c.github.io/epub-specs/epub34/a11y/)
  - type: input
    id: section
    attributes:
      label: Section
