...
body: 
  - type: markdown
    attributes:
     value: "## Issue on the [EPUB 3](https://www.w3.org/TR/epub/) Recommendation"
  - type: markdown
    attributes:
     value: __Before opening an issue__, please check that it has not already been resolved in the latest [editor's draft](https://w3c.github.io/epub-specs/epub34/authoring/)
  - type: input
    id: section
    attributes:
      label: Section
