...
description: Issue related to the EPUB Reading Systems Recommendation 
labels: Spec-ReadingSystems
body: 
  - type: markdown
    attributes:
     value: "## Issue on the [EPUB Reading Systems](https://www.w3.org/TR/epub-rs/) Recommendation"
  - type: markdown
    attributes:
     value: __Before opening an issue__, please check that it has not already been resolved in the latest [editor's draft](https://w3c.github.io/epub-specs/epub34/rs/)
  - type: input
    id: section
    attributes:
      label: Section
